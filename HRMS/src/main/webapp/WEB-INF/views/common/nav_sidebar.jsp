    ...
    <div id="left-sidebar" class="sidebar">
        <div class="sidebar-scroll">
            <div class="user-account">
                ...
                <div class="dropdown">
                    <span>Welcome,</span>
                    <a href="javascript:void(0);" class="dropdown-toggle user-name" data-toggle="dropdown">${pageContext.request.userPrincipal.name}</strong></a>                    
                    ...
                    <ul class="dropdown-menu dropdown-menu-right account animated flipInY">
                        ...
                        <li class="divider"></li>
                        <li></i><a onclick="document.forms['logoutForm'].submit()">Logout</a></li>
                    ...
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li><a href="all-employee">All Employees</a></li>
                                    <li><a href="leave-request">Leave Requests</a></li>
